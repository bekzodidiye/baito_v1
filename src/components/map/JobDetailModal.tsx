              ...
              <div className="flex items-center justify-between mb-2">
                ...
                {distanceToSelectedJob ? (
                  <span className="text-[11px] text-blue-600 font-bold flex items-center gap-1">
                    <Navigation size={11} className="rotate-45 text-blue-600 fill-blue-600/20" />
                  ...
                  <button
                    ...
                    disabled={isLocating}
                    className="text-[11px] text-blue-600 hover:underline font-bold flex items-center gap-1 cursor-pointer disabled:opacity-75"
                  >
